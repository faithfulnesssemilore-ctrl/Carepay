...
class Register extends Component
{
    ...
    public $firstName, $lastName, $email, $phone, $passkey, $passkey_confirmation, $pin, $pin_confirmation,
           $idDocument, $idType, $idNumber, $termsAccepted = false;
    ...
    public function sendOtp()
    {
        ...
        $this->dispatch('enable-resend', delay: 60);
    }
    ...
    public function submit()
    {
        ...
        $user = \App\Models\User::create([
            ...
            'email' => $this->email,
            'phone' => $this->phone,
            'password' => Hash::make($this->passkey),
            'id_document' => $this->idDocument->store('id_documents', 'public'),
            'id_type' => $this->idType,
    ...
    protected $messages = [
        ...
        'pin_confirmation' => 'PIN confirmation does not match fuck u.',
        'passkey.required' => 'Password is required.',
        'passkey.confirmed' => 'Password confirmation does not match.',
